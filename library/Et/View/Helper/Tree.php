...
class Et_Form_Element_Tree extends Zend_Form_Element
{
    ...
    public function __construct($spec, $options = null)
    {
        ...
        $this->_dynatreeScriptDir = $options['dynatree_url'];
        usnet($options['dynatree_url']);
        $this->_jqueryScriptDir = $options['jquery_url'];
        usnet($options['jquery_url']);
    ...
    protected function getScript()
    {
        ...
        if(! self::$isLoad)
        {
            ...
            <script type=\"text/javascript\" src=\"{$this->_jqueryScriptDir}/jquery-ui.custom.min.js\"></script>
